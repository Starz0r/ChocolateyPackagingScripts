...
PKG_NAME: Final[str] = "luau-lsp"
REPO: Final[str] = "JohnnyMorganz/luau-lsp"
...
PKG_DEFS: Final[dict[str, str]] = {
    ...
    "project": "https://github.com/JohnnyMorganz/luau-lsp",
    "icon": "",
    "copyright": "Copyright © 2022 - 2023, Johnny Morganz",
    "licenseUrl": "",
    ...
    "tags": "luau-lsp luau oss language-server roblox foss lsp",
...
def on_release(rel: GitRelease):
    asset = get_correct_release_asset(
        rel.get_assets(), "luau-lsp-win64.zip", None)
