...
def main():
    logger = logging.getLogger('Files GitHub Releases')
    logger.setLevel(logging.DEBUG)

    for rel in on_new_git_release("files", "files-community/files"):
        # correlate assets
